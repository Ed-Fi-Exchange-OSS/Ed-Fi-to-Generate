...
use generate
	...
	exec rds.Migrate_DimDates_Students 'submission', 'rds', 8
...
declare @k12StudentRoleId as int
	...
	where r.EntryDate <= s.SubmissionYearDate and (r.ExitDate >= s.SubmissionYearDate or r.ExitDate is null)
		...
		--select AssessmentSubjectCode, * from
		--rds.DimAssessments assess where AssessmentSubjectCode <> 'MISSING'
		--	where assess.AssessmentSubjectCode = '09999'
		--	and assess.AssessmentTypeCode = 'REGASSWOACC'
		--	and assess.ParticipationStatusCode = 'REGPARTWOACC'
		--	and assess.PerformanceLevelCode = 'L1'
		--	and assess.SeaFullYearStatusCode = 'MISSING'
		--	and assess.LeaFullYearStatusCode = 'MISSING'
		--	and assess.SchFullYearStatusCode = 'MISSING'