...
/* NOTE - JC 11/16
	In 'RefAcademicSubject' there were 2 active mappings for the incoming value 'English Language Arts'
	1. (2018, 'RefAcademicSubject', null, 'English Language Arts', '00554') --Language arts
	2. (2018, 'RefAcademicSubject', null, 'English Language Arts', '13373') --Reading/Language Arts
	I commented out insert 2 to complete the load
*/
...
delete from ODS.SourceSystemReferenceData where TableName = 'RefOperationalStatus' and TableFilter = 'LEA'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefOperationalStatus' and TableFilter = 'K12School'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefOperationalStatus' and TableFilter = 'Organization'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefOrganizationLocationType'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefOrganizationIdentificationSystem' and TableFilter = 'SEA'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefOrganizationIdentificationSystem' and TableFilter = 'LEA'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefOrganizationIdentificationSystem' and TableFilter = 'K12School'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefOrganizationIdentificationSystem' and TableFilter = 'Organization'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefSchoolType'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefCharterSchoolType'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefCharterSchoolApprovalAgencyType'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefInternetAccess'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefTitleIschoolStatus'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefMagnetSpecialProgram'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefAdministrativeFundingControl'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefInstitutionTelephoneType'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefGunFreeSchoolsActReportingStatus'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefPublicSchoolChoiceStatus'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefGradeLevel'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefSchoolLevel'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefCalendarEventType'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefSessionType'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefSex'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefUscitizenshipStatus'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefEducationLevel'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefRace'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefPersonLocationType'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefCredentialType'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefOtherNameType'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefEmailType'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefLanguageUseType'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefPersonTelephoneNumberType'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefLanguage'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefPersonIdentificationSystem' and TableFilter = '001571'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefProgramType'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefOrganizationRelationship'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefActivityRecognitionType'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefAcademicHonorType'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefHighSchoolDiplomaDistinctionType'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefHighSchoolDiplomaType'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefExitOrWithdrawalType'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefPromotionReason'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefNonPromotionReason'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefEntryType'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefPublicSchoolResidence'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefSpecialEducationExitReason'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefIdeaeducationalEnvironmentSchoolAge'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefIDEAEducationalEnvironmentEC'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefAcademicSubject'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefIncidentBehavior'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefIncidentLocation'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefWeaponType'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefIncidentReporterType'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefEmploymentStatus'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefK12staffClassification'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefIncidentPersonRoleType'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefDisabilityType'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefMepEnrollmentType'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefMepServiceType'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefContinuationOfServices'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefAssessmentParticipationIndicator'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'AssessmentPerformanceLevel_Identifier'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefAssessmentReasonNotCompleting'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefAssessmentTypeChildrenWithDisabilities'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefAssessmentPurpose'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefAssessmentType'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefFoodServiceEligibility'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefLeaType'
...
--Remove the old data before repopulating
--delete from ODS.SourceSystemReferenceData where TableName = 'RefMilitaryConnectedStudentIndicator'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefDisciplineReason'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefDisciplineMethodOfCwd'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefDisciplinaryActionTaken'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefIDEAInterimRemoval'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'IDEAInterimRemovalReason'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefPersonStatusType'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefSharedTimeIndicator'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefNSLPStatus'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefReconstitutedStatus'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefVirtualSchoolStatus'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefTitleIProgramStaffCategory'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefSpecialEducationAgeGroupTaught'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefParaprofessionalQualification'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefSpecialEducationStaffCategory'
...
--Remove the old data before repopulating
delete from ODS.SourceSystemReferenceData where TableName = 'RefTitleIIndicator'
